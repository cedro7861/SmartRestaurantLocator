...
const AdminSettingsTab: React.FC<AdminSettingsTabProps> = ({
  ...
  const adminOptions = [
    ...
    },
    {
      ...
      icon: "pulse-outline",
      onPress: () => navigation.navigate("SystemHealthScreen"),
    },
    {
  ...
  const renderSettingItem = (
    item: (typeof adminOptions)[0], // Use any option type for flexibility
    index: number
  ) => (
    <TouchableOpacity
      key={index}
    ...
    >
      ...
      >
        ...
        <View style={styles.settingsList}>
          {adminOptions.map(renderSettingItem)}
        </View>
        ...
        <View style={styles.settingsList}>
          {legalOptions.map(renderSettingItem)}
        </View>
